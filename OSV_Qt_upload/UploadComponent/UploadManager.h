...
public:
    ...
    void requestNewPhoto(PersistentSequence* sequence, const int sequenceIndex,
                         const int photoIndex);
    void requestNewVideo(PersistentSequence* sequence, const int sequenceIndex,
...
signals:
    ...
    void NewPhotoFailed(PersistentSequence* sequence, const int sequenceIndex,
                        const int photoIndex);
    void NewVideoFailed(PersistentSequence* sequence, const int sequenceIndex,
                        const int videoIndex);
...
public slots:
    ...
    void onNewPhotoFailed(PersistentSequence* sequence, const int sequenceIndex,
                          const int photoIndex);
    void onNewVideoFailed(PersistentSequence* sequence, const int sequenceIndex,
                          const int videoIndex);
